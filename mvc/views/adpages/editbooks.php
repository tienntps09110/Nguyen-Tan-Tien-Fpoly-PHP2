            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                       <h2><strong>Sửa</strong> sách</h2>
                    </div>
                    <div class="card-body card-block">
                        <form action="../adbooks/post_edit_books" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <?php foreach($data["books"]->fetchAll() as $row){ ?>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="name" value="<?php echo $row["name"] ?>" placeholder="Nhập tên sách" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="url_book" class=" form-control-label">Url sách</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="url_book" value="<?php echo $row["url_book"] ?>" placeholder="Nhập tên sách" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="content" class=" form-control-label">Nội dung</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="content" value="<?php echo $row["content"] ?>" placeholder="Nhập tên sách" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="pages" class=" form-control-label">Số trang</label></div>
                                <div class="col-12 col-md-9"><input type="number" id="text-input" name="pages" value="<?php echo $row["pages"] ?>" placeholder="Nhập số trang sách" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="publish_house" class=" form-control-label">Nhà xuất bản</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="publish_house" value="<?php echo $row["publish_house"] ?>" placeholder="Nhập tên nhà xuất bản" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="date_publish" class=" form-control-label">Ngày xuất bản</label></div>
                                <div class="col-12 col-md-9"><input type="date" id="text-input" name="date_publish" value="<?php echo $row["date_publish"] ?>" placeholder="Nhập ngày xuất bản" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="width_height" value="<?php echo $row["width_height"] ?>" placeholder="Nhập kích thước sách" class="form-control"><small class="help-block form-text">Ví dụ: 23 x 15</small></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="price" class=" form-control-label">Giá sách</label></div>
                                <div class="col-12 col-md-9"><input type="number" id="text-input" name="price" value="<?php echo $row["price"] ?>" placeholder="Nhập giá sách" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="sale_price" class=" form-control-label">Giảm giá</label></div>
                                <div class="col-12 col-md-9"><input type="number" id="text-input" name="sale_price" value="<?php echo $row["sale_price"] ?>" placeholder="Nhập phần trăm giảm giá" class="form-control"><small class="help-block form-text">Ví dụ: giảm 10% thì nhập 10,không giảm nhập 0.</small></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="total" class=" form-control-label">SL sản phẩm trong kho</label></div>
                                <div class="col-12 col-md-9"><input type="number" id="text-input" name="total" value="<?php echo $row["total"] ?>" placeholder="Nhập số lượng sản phẩm trong kho" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                        ...
                        <button class="btn btn-success float-right">Update sản phẩm</button>
                    <?php } ?>
                    </form>      
        </div>
